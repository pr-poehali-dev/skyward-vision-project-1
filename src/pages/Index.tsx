...
const Index = () => {
  ...
  const faqs: FAQ[] = [
    ...
    {
      question: "Предлагаете ли вы сезонное обслуживание?",
      answer:
        "Да. После завершения работ мы предлагаем сезонное обслуживание сада: стрижку, подкормку растений, подготовку к зиме и весеннее восстановление. Это позволяет поддерживать участок в идеальном состоянии круглый год.",
    },
    {
          ...
          <div className="rounded-3xl bg-white/[0.03] backdrop-blur-2xl ring-1 ring-white/10 p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {["Портфолио", "Наша команда", "Отзывы клиентов", "О компании"].map((item) => (
                    <li key={item}>
                      <a href="#" className="text-white/70 hover:text-white transition-colors text-sm leading-relaxed">
                        {item}
                      </a>
